...
#'
#' @return list containing base widths (a), heights (h), cumulative height (cum.h), 
#' a:h ratio (ah_ratio), volumes (V), geometric mean transfer efficiency (TEgm), 
#' cumulative volume (cum.V) 
#' 
#' @export
#'
#' @examples
#' # From Tam et al (2008) - Northern Humboldt Cureent Ecosystem (1995-1996)
#' TEgm <- 0.1014
...
V2Pdim <- function(V, TEgm){
  ...
  ah_ratio <- -log10(TEgm) # 1 / (1-log(1-TEgm)) # a/h ratio
